...
exports.listingsResolver = {
    ...
    Mutation: {
        hostListing: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const imageUrl = yield api_1.Cloudinary.upload(input.image, input.imagePath);
        ...
        hostImagePreview: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                yield db.users.updateOne({
                    _id: input.id,
            ...
            const host = yield db.users.findOne({ _id: input.id });
            return host;
        }),
    },
    Listing: {
